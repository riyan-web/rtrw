...
<ul class="list">
	...
	<div class="body">
		<form action="https://demonya.xyz/sirt/index.php/Admin/update_setting" method="post">
			<table style="width: 100%">
				<tr>
					<td>Kampung / Komplek</td>
					<td>:</td>
					<td><input type="text" name="komplek" class="form-control" value="PRUMNAS BENGKURAT PERMAI RT.09"></td>
				</tr>
				<tr>
					<td>RW</td>
					<td>:</td>
					<td><input type="text" name="rw" class="form-control" value="01"></td>
				</tr>
				<tr>
					<td>Kelurahan</td>
					<td>:</td>
					<td><input type="text" name="kelurahan" class="form-control" value="SARI BUNGAMAS"></td>
				</tr>
				<tr>
					<td>Kecamatan</td>
					<td>:</td>
					<td><input type="text" name="kecamatan" class="form-control" value="LAHAT"></td>
				</tr>
				<tr>
					<td>Kota / Kab</td>
					<td>:</td>
					<td><input type="text" name="kota" class="form-control" value="LAHAT"></td>
				</tr>
				<tr>
					<td>Kode Pos</td>
					<td>:</td>
					<td><input type="text" name="kode_pos" class="form-control" value="31419"></td>
				</tr>
				<tr>
					<td>Provinsi</td>
					<td>:</td>
					<td><input type="text" name="provinsi" class="form-control" value="SUMATERA SELATAN"></td>
				</tr>
