    ...
    <section class="content">
      ...
      <hr>
        <div class="container-fluid">
            ...
            <div class="card">
	<div class="header bg-blue">Konfigurasi</div>
	<div class="body">
		<div class="row">
			<div class="col-md-3">
				<a href="https://demonya.xyz/sirt/index.php/Admin/setting" class="btn bg-blue form-control">Setting Tempat</a>
			</div>
			<div class="col-md-3">
				<a href="https://demonya.xyz/sirt/index.php/Admin/user" class="btn bg-blue form-control">Setting Role User</a>
			</div>
			<div class="col-md-3">
				<a href="https://demonya.xyz/sirt/index.php/Rt" class="btn bg-blue form-control">Setting Jumlah RT</a>
			</div>
			<div class="col-md-3">
				<a href="https://demonya.xyz/sirt/index.php/Admin/warga" class="btn bg-blue form-control">Entri Warga</a>
			</div>
			<div class="col-md-3">
				<a href="https://demonya.xyz/sirt/index.php/Admin/logo" class="btn bg-blue form-control">Upload Logo</a>
			</div>
		</div>
	</div>
</div>        </div>
