...
<li class="header">MENU WARGA</li>
	...
	<div class="body">
		<div class="row">
			<div class="col-md-3">
				<a href="setting-tempat.php" class="btn bg-blue form-control">Setting Tempat</a>
			</div>
			<div class="col-md-3">
				<a href="setting-role.php" class="btn bg-blue form-control">Setting Role User</a>
			</div>
			<div class="col-md-3">
				<a href="setting-jumlahrt.php" class="btn bg-blue form-control">Setting Jumlah RT</a>
			</div>
			<div class="col-md-3">
				<a href="tambah-warga.php" class="btn bg-blue form-control">Entri Warga</a>
			</div>
			<div class="col-md-3">
				<a href="upload-logo.php" class="btn bg-blue form-control">Upload Logo</a>
			</div>
		</div>
	</div>
</div>        </div>
