...
<ul class="list">
	...
	<div class="col-md-4">
		<form action="https://demonya.xyz/sirt/index.php/Admin/upload_logo" method="post" enctype="multipart/form-data">
			<div class="card">
	...
	<div class="col-md-8">
		<div class="card">
				...
				<div class="body">
					<img src="https://demonya.xyz/sirt/assets/upload/logo">
				</div>
			</div>
	</div>
