    ...
    <section class="content">
      ...
      <hr>
        <div class="container-fluid">
            ...
            <div class="card">
	<div class="header bg-blue">Pembayaran Iuran Bulan Januari 2019</div>
	<div class="body">

		<form action="https://demonya.xyz/sirt/index.php/Home/bayarkan/" method="post" enctype="multipart/form-data">
			<input type="hidden" name="id_b_iuran" value="7">
