    ...
    <section class="content">
      ...
      <hr>
        <div class="container-fluid">
            ...
            <div class="card">
	<div class="header bg-light-blue">Pilih Ketua RW</div>
	<div class="body">
		<table class="table table-hover dataTable js-exportable">
			...
			<tbody>
								<tr>
					<td>1</td>
					<td><a href="https://demonya.xyz/sirt/index.php/Warga/profil/1234567891011">Edi</a></td>
					<td>Warga RT 1</td>
					<td>KETUA RW <a href="https://demonya.xyz/sirt/index.php/Admin/jadikan_warga/24" class="btn bg-blue" onclick="confirm('Role User ini akan dijadikan warga, apakah anda yakin?');">Jadikan Role Warga</a></td>
				</tr>
							</tbody>
		</table>
	</div>
